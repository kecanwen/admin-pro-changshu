<template>
  <div class="supplier-management-container">
    ...
    >
      ...
      <el-table-column align="center" label="供应商编码 " prop="Code" />
      <el-table-column align="center" label="供应商名称" prop="Name" />
      <el-table-column align="center" label="联系人" prop="LinkUser" />
...
<script>
  import { doDelete, getList } from '@/api/supplierManagement'
  import Edit from './components/supplierManagementEdit'
