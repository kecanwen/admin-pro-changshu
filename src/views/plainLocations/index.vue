<template>
  <div class="plainLocations-management-container">
    <vab-query-form>
    ...
    >
      ...
      <el-table-column align="center" label="模式" prop="OutModel" />
      <el-table-column align="center" label="请求类型" prop="RequestType" />
...
<script>
  import {
    ...
    getList,
  } from '@/api/plainLocationsManagement'
  import Edit from './components/plainLocationsManagementEdit'

  export default {
    name: 'PlainLocationsManagement',
    components: { Edit },
    data() {
      return {
        list: [],
