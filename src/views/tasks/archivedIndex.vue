<template>
  <div class="archiveds-management-container">
    <vab-query-form>
    ...
    >
      ...
      <el-table-column
        ...
        width="160"
      />
      <el-table-column align="center" label="完成状态" prop="CompleteStatus" />
  ...
  export default {
    ...
    methods: {
      ...
      async fetchData() {
        ...
        const {
          data: { list, total },
        } = await getArchivedsList(this.queryForm)
        this.list = list
        this.total = total
